...
카펫 문제는 노란 격자의 가로 개수와 브라운 격자의 개수를 매칭시켜 브라운 격자의 개수가 맞을 때 노란 격자의 가로 개수를 y2에 저장하여 풀면 된다.

1. 노란 격자의 가로 개수를 y2에 저장
2. 노란 격자의 가로 개수(y2)와 노란 격자의 세로 개수(i)를 활용해 브라운 격자의 개수를 구함.
3. 브라운 격자의 개수와 동일하면 w = 노란 격자의 가로 개수(y2) + 2, h = 노란 격자의 세로 개수(i) + 2
4. [w, h] 반환
...
> <br />
> 참고한 블로그: https://dippingtodeepening.tistory.com/82
